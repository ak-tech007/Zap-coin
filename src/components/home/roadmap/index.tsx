export const Roadmap = () => {
  return (
    <>
      <div
        className="relative max-[450px]:h-[85rem] max-[640px]:h-[60rem] sm:h-[50rem] md:h-[47rem] lg:h-[63rem] xl:h-[63rem] 2xl:h-[80rem]"
        style={{
      ...
      >
        <div
          id="Roadmap"
          className="flex flex-col items-start max-[450px]:pt-[12rem] max-[640px]:text-[1.2rem] max-[640px]:w-[90vw] max-[640px]:mx-auto max-[640px]:gap-[1rem] max-[640px]:pt-[13rem] sm:w-[80vw] sm:mx-auto xl:w-[60vw] 2xl:w-[50vw]  text-[#073736] sm:pt-[10rem] sm:gap-[1rem]  sm:text-[1rem] sm:leading-[1.5rem] md:pt-[10rem] lg:pt-[16rem] lg:gap-[3rem] 2xl:pt-[20rem] "
        >
          <div
