export const Tokenpayment = () => {
  return (
    <>
      {/* <div className="min-[1200px]:absolute min-[1200px]:top-[20%] max-lg:-mx-[80px]">
...
<div className="min-[1200px]:absolute relative w-[32rem] 2xl:w-[35rem] top-[20%] " >
            ...
            <span className="absolute myriadpro_regular text-white top-[25.3%] text-[0.7rem] left-[39%] 2xl:top-[25.5%] 2xl:text-[0.7rem]  2xl:left-[40%]">Until next Price increase</span>
            ...
            <div className="absolute flex justify-between w-[52%] top-[74%] left-[24%] text-[0.76rem] 2xl:w-[52%] 2xl:top-[74%] 2xl:left-[24%] 2xl:text-[0.8rem]">
                ...
                <div className="myriadpro relative rounded-[1rem] w-[45%]">
                    <img src="button/button1.png"></img>
                    <span className="absolute top-[9%] left-[2%] px-[7.7%] py-[2.6%] 2xl:top-[10%] 2xl:left-[2%] rounded-[2rem] 2xl:px-[9.5%] 2xl:py-[3%] cursor-pointer hover:bg-[#1a82ab]">Don't Have Wallet</span>
                </div>
            </div>
        </div>
    </>
