  ...
  return (
    <>
      ...
      >
        ...
        <div className="sm:w-[500px] ml-[10px] scale-y-125 leading-7 py-[35px] text-[24px] max-md:text-[20px] ">
          Congratulations! <br />
        ...
        <ul className="ml-[10px] sm:w-[500px] min-[1024px]:w-[400px] scale-y-125 leading-[23px] py-[30px] text-[22px] max-md:text-[18px]">
          ...
          >
            What is $ZAP?&nbsp;&nbsp;&nbsp;
            <span className="text-black cursor-pointer underline underline-offset-2  text-[16px]">
              Learn More
            </span>
          </li>
        </ul>
